            ...
            <form id="updateurl" method="post" action="{{ route('url.update', $url->id) }}">
                ...
                <div id="shorturl" class="row justify-content-center showhide mt-4 align-items-center">
                    ...
                    <div class="col-12 col-md-8 pl-1 mr-0">
                        <input class="form-control" type="text" name="urltoken" id="urltoken"
                               value="{{ $url->token }}" required>
                        <input type="hidden" id="urltoken_" value="{{ $url->token }}">
                    </div>
                </div>
                ...
                <div class="row justify-content-center mt-3">
                    <div class="col-12 col-md-6">
                        <button class="btn btn-custom btn-block" type="submit">{{ __('Update URL') }}</button>
                    </div>
                </div>
            </form>
        </div>
